...
- Decodes HSD name resource values into DNS-style DS, NS, in-zone glue A/AAAA, synthetic glue A/AAAA, TXT records, and an experimental explicit HNS browser TXT capsule for synthesized apex or single-label child A/AAAA, HTTPS, and TLSA answers.
