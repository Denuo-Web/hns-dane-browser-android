...
| Android App Bundle | Rebuild required | Package identity is `com.denuoweb.hnsdane`; create a new upload AAB such as `dist/play-store/hns-dane-browser-v0.3.6-play-upload-signed.aab`. |
...
PLAY_TRACK=alpha \
  ...
  dist/play-store/hns-dane-browser-v0.3.6-play-upload-signed.aab
```
...
1. Build and verify `dist/play-store/hns-dane-browser-v0.3.6-play-upload-signed.aab`.
