...
- Build and upload a fresh `dist/play-store/hns-dane-browser-v0.3.6-play-upload-signed.aab` to the closed testing track in Play Console for package `com.denuoweb.hnsdane`.
