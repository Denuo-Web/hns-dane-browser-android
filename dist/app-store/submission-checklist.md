...
Canonical first-release values: iOS version `0.5.0`, build `42`, bundle ID
...
- [ ] Set the version to `0.5.0`, select build `42`, and leave Routing App Coverage
  empty.
...
- [ ] Confirm build `42` has finished processing and its export-compliance status is
  resolved.
